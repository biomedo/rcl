...
# Time-stamp: <2010-12-09 01:01:17 Thursday by lian>
...
* 文本编辑
  ...
  - C-s {M-n; M-p} 搜索的历史记录
* Python mode
  - C-c C-z switch to python interpreter
  - M-x python-send-defun
  - M-x python-send-buffer
  - M-x python-send-region
  - C-c C-k python-mark-block
  - C-c C-s python-send-string
  - C-c C-w python-check
  - C-c {> ; <} python-shift-left or right
* 技巧Tis
